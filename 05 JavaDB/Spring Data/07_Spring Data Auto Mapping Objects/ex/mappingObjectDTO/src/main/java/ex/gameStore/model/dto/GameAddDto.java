...
public class GameAddDto {
    ...
    public GameAddDto(String title, BigDecimal price, Double size, String trailer, String imageThumbnail,
...
@Pattern(regexp = "^(https?:\\/\\/).*$", message ="Enter valid imageThumbnail")
